...
public class verifyOTP2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn = findViewById(R.id.OTPbutton021);
        text=findViewById(R.id.otp01);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(TextUtils.isEmpty(text.getText().toString())){
                    Toast.makeText(verifyOTP2.this, "Please Enter OTP", Toast.LENGTH_SHORT).show();
                }else{
    ...
    private void signIntheuserbyCredentials(PhoneAuthCredential credential) {
        ...
        firebaseAuth.signInWithCredential(credential).addOnCompleteListener(verifyOTP2.this, new OnCompleteListener<AuthResult>() {
            @Override
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    Intent intent = new Intent(verifyOTP2.this,MainActivity.class);
                    startActivity(intent);
                    finish();
                }else{
                    Toast.makeText(verifyOTP2.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
